...
>(({ className, children, ...props }, forwardedRef) => (
  <DropdownMenuPrimitives.SubTrigger
    ...
    className={cx(
      ...
      // focus
      "focus-visible:bg-subtle data-[state=open]:bg-subtle",
      // hover
      "hover:bg-subtle",
      //
      className,
...
>(({ className, shortcut, hint, children, ...props }, forwardedRef) => (
  ...
  >
    ...
    {hint && (
      <span
        className={cx("ml-auto pl-2 text-sm text-faint")}
      >
        {hint}
      </span>
    )}
  ...
  (
    ...
    >
      ...
      {hint && (
        <span
          className={cx(
            "ml-auto text-sm font-normal text-faint",
          )}
        >
          {hint}
        </span>
      ...
      {shortcut && (
        <span
          className={cx(
            "ml-auto text-sm font-normal tracking-widest text-faint",
          )}
        >
          {shortcut}
        </span>
    ...
    >
      {iconType === "radio" ? (
        <span className="absolute left-2 flex size-4 items-center justify-center">
          ...
          <RiCheckboxBlankCircleLine
            aria-hidden="true"
            className="size-full shrink-0 text-faint group-data-[state=unchecked]/DropdownMenuRadioItem:flex group-data-[state=checked]/DropdownMenuRadioItem:hidden"
          />
        </span>
      ) : iconType === "check" ? (
        <span className="absolute left-2 flex size-4 items-center justify-center">
  ...
  return (
    <div
      className={cx(
        ...
        "text-muted-foreground",
        // disabled
        "group-data-[disabled]/DropdownMenuItem:text-faint",
        className,
      )}
      {...props}
    />
