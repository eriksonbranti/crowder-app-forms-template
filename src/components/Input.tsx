...
const inputStyles = tv({
  base: [
    ...
    [
      ...
      "file:border-solid file:border-border file:bg-muted file:text-muted-foreground file:hover:bg-subtle",
      "file:[border-inline-end-width:1px] file:[margin-inline-end:0.75rem]",
      "file:disabled:bg-subtle file:disabled:text-muted-foreground",
    ],
    // focus
    focusInput,
    // invalid (optional)
        ...
        {isPassword && (
          ...
          >
            ...
            >
              ...
              {typeState === "password" ? (
                <RiEyeLine aria-hidden="true" className="size-4 shrink-0" />
              ) : (
                <RiEyeOffLine aria-hidden="true" className="size-4 shrink-0" />
              )}
            </button>
          </div>
        )}
